...
<h3>Forum</h3>
    ...
    <div class="btn1">
    <a href="admin_forum_post.php">  <button class="btn btn-primary newbtn"><b>+ New Post</b></button> </a>
    </div>
    <div class="t">
        <table class="table">
  <thead>
...
if($result){
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        if($name=="Admin")
        {
          ...
          <td class="heading">
          <button class="btn btn-primary btnop"><a href="admin_update_forum.php? update='.$id.'" class="text-light link">Update</a></button>
          <button class="btn btn-danger btnop"><a href="admin_delete_forum.php? delete='.$id.'" class="text-light link">Delete</a></button>
          </td>          
          </tr>';
